...
The video here below shows the example of the [TAG Selector in the Composer](https://github.com/denvergeeks/discourse-composer-horizontal-tag-selector) Component in action... but this Component provides the same behavior, but for this *CATEGORY* selector in the Composer...
