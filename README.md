...
The video here below shows the [TAG Selector in the Composer](https://github.com/denvergeeks/discourse-composer-horizontal-tag-selector) Component... but this Component provides the same behavior, but for the CATEGORY selector in the Composer
